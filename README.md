...
## Algorithm
```
1. Import the required libraries and load the dataset containing employee experience and salary details.
2. Split the dataset into input features and target values for training the model.
3. Train the Decision Tree Regressor model using the training dataset.
4. Predict the salary of the employee using the trained model and display the results.
```
...
## Output:
![image](https://github.com/VGSAIRAIMA/Implementation-of-Decision-Tree-Regressor-Model-for-Predicting-the-Salary-of-the-Employee/blob/main/Screenshot%202026-05-23%20071622.png)
